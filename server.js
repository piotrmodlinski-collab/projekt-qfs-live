...
function generateDefaultPanelData() {
  const seedTasks = [
    { id: "task-001", title: "Podpiecie domeny i routing logowania /logowanie", status: "review", priority: "critical", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-002", title: "Strona glowna: spojne menu, logo i footer", status: "review", priority: "high", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-003", title: "Outsourcing: unifikacja UX i sekcji wzgledem glownej", status: "review", priority: "high", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-004", title: "Outsourcing Classic: poprawa layoutu, scrolla i linkow produkcji", status: "review", priority: "high", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-005", title: "Kontakt: dopasowanie formularza i kart do design systemu QFS", status: "review", priority: "high", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-006", title: "Mini gra monitor: CTA do Centrum kontaktu i aktualizacja copy", status: "review", priority: "medium", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-007", title: "Ezoteva: menu gry, panel contentu i flow sekcji Project/Media", status: "review", priority: "critical", assignee: "Piotr", dueDate: dayPlus(1), labels: ["EZOTEVA"] },
    { id: "task-008", title: "Ezoteva: galeria miniaturek + fullscreen dla obrazow i video", status: "review", priority: "high", assignee: "Piotr", dueDate: dayPlus(1), labels: ["EZOTEVA"] },
    { id: "task-009", title: "Hiberman: strona w stylu referencji + osobne tlo video", status: "review", priority: "critical", assignee: "Piotr", dueDate: dayPlus(1), labels: ["HIBERMAN"] },
    { id: "task-010", title: "Footer globalny: sociale + ikona logowania do portalu", status: "review", priority: "medium", assignee: "Piotr", dueDate: dayPlus(1), labels: ["WWW"] },
    { id: "task-011", title: "Level design: ustawienie punktu startowego i otwarcie gry spod gory cial zombie", status: "in_progress", priority: "high", assignee: "Piotr", labels: ["LEVEL DESIGN"] },
    { id: "task-012", title: "Akt 1: rozpisanie misji glownych, pobocznych i dialogow", status: "in_progress", priority: "high", assignee: "Piotr", labels: ["NARRACJA"] },
    { id: "task-013", title: "Przygotowanie materialow do galerii Ezoteva", status: "todo", priority: "medium", assignee: "Piotr", labels: ["EZOTEVA"] },
    { id: "task-014", title: "Przebudowanie strony internetowej", status: "on_hold", priority: "high", assignee: "Piotr", labels: ["WWW"] },
    { id: "task-015", title: "UI dla portalu", status: "on_hold", priority: "high", assignee: "Piotr", labels: ["UI"] },
    { id: "task-016", title: "UI dla inventory", status: "on_hold", priority: "high", assignee: "Piotr", labels: ["UI"] },
    { id: "task-017", title: "HUD", status: "on_hold", priority: "high", assignee: "Piotr", labels: ["UI"] },
    { id: "task-018", title: "Przygotowanie intro", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["GAMEPLAY"] },
    { id: "task-019", title: "Przygotowanie character selection", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["GAMEPLAY"] },
    { id: "task-020", title: "Tekst do character selection", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["NARRACJA"] },
    { id: "task-021", title: "Przygotowanie metahuman Tessa", status: "backlog", priority: "high", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-022", title: "Bohater glowny", status: "backlog", priority: "high", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-023", title: "Ubranie 1", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-024", title: "Zombie 1", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-025", title: "Zombie 2", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-026", title: "Zombie 3", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-027", title: "Zombie 4", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["CHARACTER"] },
    { id: "task-028", title: "Podpiecie SFX", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["AUDIO"] },
    { id: "task-029", title: "Podpiecie Music", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["AUDIO"] },
    { id: "task-030", title: "Ustawienie designu dla dialogow", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["UI"] },
    { id: "task-031", title: "Ustawienie designu dla dialogu bez wyboru (ktos do nas mowi)", status: "backlog", priority: "medium", assignee: "Piotr", labels: ["UI"] },
  ];
